...
TARGET_URL = os.getenv('TARGET_URL', 'http://web_app:8000')
STRESS_LEVEL = os.getenv('STRESS_LEVEL', 'low')

# Stress level configurations
STRESS_CONFIGS = {
    'low': {'threads': 1, 'requests_per_thread': 10, 'delay': 0.5},
    'medium': {'threads': 5, 'requests_per_thread': 20, 'delay': 0.1},
    'high': {'threads': 8, 'requests_per_thread': 40, 'delay': 0.05},
    'extreme': {'threads': 50, 'requests_per_thread': 200, 'delay': 0.001},
